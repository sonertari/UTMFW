...
if (filter_has_var(INPUT_POST, 'Login')) {
	$Result= UserDatabaseAuthentication(filter_input(INPUT_POST, 'UserName'), filter_input(INPUT_POST, 'Password'), filter_input(INPUT_POST, 'Description'));
				...
				<td>
					...
					<form action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF') ?>" method="post">
						<table id="window">
							...
							<tr>
								<td class="authbox">
									<?php echo _TITLE('You must authenticate to access the Internet') ?>
									<table id="authbox">
											<tr>
												<td class="label">
